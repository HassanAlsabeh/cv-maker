...
export default function Chatcompany({ route, navigation }) {
  const file_path = route.params;
  console.log("chattattattatat", file_path);
  ...
  useEffect(() => {
    navigation.setOptions({
        ...
        <View style={styles.headerLeft}>
          ...
          >
            <Text style={{ color: "#111", fontWeight: "700", fontSize: 18 }}>
              {file_path.user_fname} {file_path.user_lname}
            </Text>
      ...
      headerRight: () => (
        ...
        >
          <Icon name="call" size={28} color="#111" />
        </TouchableOpacity>
      ),
    });
  }, []);
